#include "./FunctiCos/StergeProdusCos.c"
#include "./FunctiCos/PutBackToList.c"

void cosInterfaceMenuPleb()
{
    int produsActual = 0;
    int fleg = 1;
    ...
    {
        system("CLS");
        int NrProduse = afisFile("Storage/Cos.txt", produsActual); // afisam interfata curenta
